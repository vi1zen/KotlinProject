 ...
 * 描   述：
 * 作   者：wz
 * 时   间：2018/03/28 16:45
 */

class NestedTextView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : android.support.v7.widget.AppCompatTextView(context, attrs, defStyleAttr), NestedScrollingChild {
    ...
    companion object {
        ...
        private val TAG = "NestedTextView"
    }
}
